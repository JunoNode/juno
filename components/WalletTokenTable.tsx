...
const WalletTokenTable: React.FC<Props> = ({ tokens }) => {
  ...
  if (!tokens.length) return <TokenEmptyState />;
  ...
  return (
    <div className="mt-6 max-w-3xl mx-auto px-4">
      ...
      <table className="w-full text-left text-sm text-gray-300">
        <thead className="border-b border-glass text-xs uppercase tracking-wide">
          <tr>
        ...
        <tbody>
          {tokens.map((token, idx) => (
            <tr
              ...
              className="border-b border-glass hover:bg-glass/40 transition"
            >
          ...
          <tr className="font-semibold text-white bg-glass/30">
